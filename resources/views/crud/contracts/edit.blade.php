                                ...
                                <div class="card-body">
                                    ...
                                    <form id="signupForm">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select select2" name="manager_id" id="manager_id">
                                                @foreach($employees as $employee)
                                                    <option value="{{ $employee->id }}" {{ ($contract->manager_id == $employee->id) ? 'selected' : '' }}>{{ $employee->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    <select class="form-select select2" name="client_id" id="client_id">
                                                        @foreach($users as $user)
                                                            <option value="{{ $user->id }}" {{ ($contract->client_id == $user->id) ? 'selected' : '' }}>{{ $user->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
